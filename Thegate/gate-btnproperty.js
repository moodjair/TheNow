...
var property = require('./config/config-property.json');
...
/* Transaction VA */
/* Inquiry VA */
router.post('/bp/inqVA', function(req, res, next) {
    // Get IP first
    var ipInfo    = getIP(req)
    var clientip  =ipInfo.clientIp;
          ...
          dataRes=
             {
              ...
              "developer"       : parseRes.OUNFAKU,
              "kodedeveloper"   : parseRes.OUNPSTU,
...
/* Create VA */
router.post('/bp/createVA', function(req, res, next) {
    // Get IP first
    var ipInfo    = getIP(req)
    var clientip  = ipInfo.clientIp;  
...
/* Delete VA */
router.post('/bp/deleteVA', function(req, res, next) {
    // Get IP first
    var ipInfo    = getIP(req)
    var clientip  = ipInfo.clientIp;
...
/* Update VA */
router.post('/bp/updVA', function(req, res, next) {
    // Get IP first
    var ipInfo = getIP(req)
    var clientip=ipInfo.clientIp;    
...
console.log("The Gate BTN Property Running on port:"+port.property)
router.listen(port.property,'0.0.0.0')